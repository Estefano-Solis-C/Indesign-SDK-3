...
#define kSVGArtRsrcType                 583
#define kSVGArtRollOverRsrcType         584
#define kSVGArtDarkRsrcType             585
#define kSVGArtRollOverDarkRsrcType     586
#define kSVGCursorRsrcType              587
