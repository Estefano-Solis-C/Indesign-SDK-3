...
class WIDGET_DECL WSaveFileDialogBase : public ISaveFileDialog
{
	public:
		...
		virtual bool16 DoDialog(const IDFile *defaultFile, IDFile* resultFile, int32* selectedIndex, bool16 useSystemDefaultDir, bool16 showTypeMenu, const PMString* title, const bool16& isSaveACopy);
	...
	protected:
		...
		virtual HRESULT AddAndInitializeCustomControls(IFileDialogCustomize* pfdc, const bool16& isSaveACopy = kFalse);
		...
		virtual void GetInitialDirectory(const IDFile *defaultFile, bool16 useSystemDefaultDir, PMString *dir, PMString *file, uint32 *initialFilter, const PMString *title);
