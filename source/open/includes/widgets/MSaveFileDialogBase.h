...
class WIDGET_DECL MSaveFileDialogBase : public ISaveFileDialog
{
	public:
		...
		virtual bool16 DoDialog(const IDFile *defaultFile, IDFile* resultFile, int32* selectedIndex, bool16 useSystemDefaultDir, bool16 showTypeMenu, const PMString* title, const bool16 & saveACopyFlag);
	...
	protected:
		...
		*/
		...
		virtual void InitializeAccessoryView(bool isSaveACopyFlag = false);
