...
public:
    ...
    void SetRsrcID(const RsrcID &id, const bool isDarkIcon);
...
protected:
	...
	*/
	...
	virtual void		SetButtonImageSupplier(void* imageBuffer, size_t bufferSize, const RsrcType rsrcType, const std::string& inImageName, EButtonState state = kNormal);
...
protected:
	...
	IconHandler				fButtonUp;
	IconHandler				fButtonDown;
