...
class WIDGET_DECL MOpenFileDialogBase : public IOpenFileDialog
{
	public:
		...
		virtual bool16 DoDialog(IDFile *defaultFile, SysFileList &resultFiles, bool16 allowMultipleFiles = kTrue, const PMString *title = nil,
								const PMString *infoMessage = nil);
		...
		//This method will launch uxp extension to place links.
        void LaunchCDPExtensionForPlaceLink();
		//This method will launch uxp extension to open cloud docs for Relink operation
        void RelinkWithCloudAsset();
