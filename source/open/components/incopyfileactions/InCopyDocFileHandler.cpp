...
public:
		...
		virtual void SaveAs(const UIDRef& doc, const IDFile *destFile = nil,
												...
												FileTypeInfoID fileTypeID = kInvalidFileTypeInfoID,SaveType saveType = kSaveAsNative);
    ...
    virtual void SaveAsCloudDoc(const UIDRef& doc, const std::string & filePath){}
    virtual bool16 CloudDocToSaveAsNativePubFile(const UIDRef& doc, const IDFile *destFile, UIFlags uiFlags);
...
bool16 InCopyDocFileHandler::CloudDocToSaveAsNativePubFile(const UIDRef& doc, const IDFile *destFile, UIFlags uiFlags)
{
    ASSERT("Feature not supported for IC");
    return false;
}
...
void InCopyDocFileHandler::SaveAs(const UIDRef& doc, const IDFile *destFile, UIFlags uiFlags, bool8 asStationery, FileTypeInfoID fileTypeID,SaveType saveType)
{	
